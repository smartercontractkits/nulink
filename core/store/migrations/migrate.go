...
import (
	...
	"nulink/core/store/migrations/migration1559081901"
	"nulink/core/store/migrations/migration1559767166"
	"nulink/core/store/migrations/migration1560433987"
	"nulink/core/store/migrations/migration1560791143"
	"nulink/core/store/migrations/migration1560881846"
	"nulink/core/store/migrations/migration1560881855"
	"nulink/core/store/migrations/migration1560886530"
	"nulink/core/store/migrations/migration1560924400"
	"nulink/core/store/migrations/migration1564007745"
	"nulink/core/store/migrations/migration1565139192"
	"nulink/core/store/migrations/migration1565210496"
	"nulink/core/store/migrations/migration1565291711"
	"nulink/core/store/migrations/migration1565877314"
	"nulink/core/store/migrations/migration1566498796"
	"nulink/core/store/migrations/migration1566915476"
	"nulink/core/store/migrations/migration1567029116"
	"nulink/core/store/migrations/migration1568280052"
	"nulink/core/store/migrations/migration1568390387"
	"nulink/core/store/migrations/migration1568833756"
	"nulink/core/store/migrations/migration1570087128"
	"nulink/core/store/migrations/migration1570675883"
	"nulink/core/store/migrations/migration1573667511"
	"nulink/core/store/migrations/migration1573812490"
	"nulink/core/store/migrations/migration1575036327"
	"nulink/core/store/migrations/migration1576022702"
	"nulink/core/store/migrations/migration1579700934"
	"nulink/core/store/migrations/migration1580904019"
	"nulink/core/store/migrations/migration1581240419"
...
func MigrateTo(db *gorm.DB, migrationID string) error {
	...
	if count > len(migrations) {
		return errors.New("database is newer than current nulink version")
	}
