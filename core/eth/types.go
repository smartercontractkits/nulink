...
// nulink. https://github.com/fjl/gencodec/issues/10)
...
// NuLinkFulfilledTopic is the signature for the event emitted after calling
// NuLinkClient.validateNuLinkCallback(requestId).
// https://nulink/blob/master/evm/contracts/NuLinkClient.sol
var NuLinkFulfilledTopic = utils.MustHash("NuLinkFulfilled(bytes32)")
...
func (txr TxReceipt) FulfilledRunLog() bool {
	for _, log := range txr.Logs {
		if log.Topics[0] == NuLinkFulfilledTopic {
			return true
		}
	}
	return false
